...
function testBytes() {
	...
	assert.equalBytes(Bytes.fromStringLiteral('hello'), [0x68, 0x65, 0x6c, 0x6c, 0x6f])
	assert.equalBytes(Bytes.fromStringLiteral('hello', 'none'), [0x68, 0x65, 0x6c, 0x6c, 0x6f])
	assert.equalBytes(Bytes.fromStringLiteral('hello', 'left'), [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x68, 0x65, 0x6c, 0x6c, 0x6f])
	assert.equalBytes(Bytes.fromStringLiteral('hello', 'right'), [0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])
}
